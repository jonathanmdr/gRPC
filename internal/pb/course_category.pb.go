...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	3, // 5: pb.CategoryService.GetCategory:output_type -> pb.CategoryResponse
	4, // 6: pb.CategoryService.GetCategories:output_type -> pb.CategoriesResponse
	3, // 7: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	4, // 8: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoriesResponse
